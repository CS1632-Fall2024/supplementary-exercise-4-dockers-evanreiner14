...
public class D3Test {
  ...
  public void tEST5RENTACAT() {
    driver.get("http://localhost:8080");
    driver.manage().window().setSize(new Dimension(748, 460));
  ...
  public void tEST9FEED() {
    ...
    wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//div[@id=\'feedResult\']"),"Nom, nom, nom."));
